...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        if ($user->save()) {
            return redirect('users')->with('message', 'The User: ' . $user->names . ' was successfully added');
        }
    ...
    {
        if ($user->delete()) {
            return redirect('users')->with('message', 'The User: ' . $user->names . ' was successfully deleted');
        }
    }
