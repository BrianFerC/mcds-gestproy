                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                <input id="names" type="text" class="form-control @error('names') is-invalid @enderror" name="names" value="{{ old('names') }}" placeholder="@lang('general.label-names')" autofocus>
                        ...
                        <div class="form-group">
                                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                                    ...
                                    <option value="Leader" @if(old('role') == 'Leader') selected @endif>Leaderr</option>
                                </select>
                        ...
                        <div class="form-group">
                            <select name="state" id="state" class="form-control @error('state') is-invalid @enderror">
                                ...
                                <option value="Activo" @if(old('state') == 'Activo') selected @endif>@lang('general.select-activo')</option>
                                <option value="Inactivo" @if(old('state') == 'Inactivo') selected @endif>@lang('general.select-inactivo')</option>
                            </select>
