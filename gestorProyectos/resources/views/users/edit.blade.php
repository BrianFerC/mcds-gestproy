                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('users/'.$user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                <input id="names" type="text" class="form-control @error('names') is-invalid @enderror" name="names" value="{{ old('names', $user->names) }}" placeholder="@lang('general.label-names')" autofocus>
                        ...
                        <div class="form-group">
                                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                                    ...
                                    <option value="Leader" @if(old('role', $user->role) == 'Leader') selected @endif>Leader</option>
                                </select>
                        ...
                        <div class="form-group">
                            <select name="state" id="state" class="form-control @error('state') is-invalid @enderror">
                                ...
                                <option value="Activo" @if(old('state', $user->state) == 'Activo') selected @endif>@lang('activo')</option>
                                <option value="Inactivo" @if(old('state', $user->state) == 'Inactivo') selected @endif>@lang('inactivo')</option>
                            </select>
